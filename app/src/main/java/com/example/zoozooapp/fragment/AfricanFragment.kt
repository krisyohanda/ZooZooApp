...
class AfricanFragment : Fragment() {

    private var _binding : FragmentAfricanBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAfricanBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val itemId = HomeFragment.AFRICAN
